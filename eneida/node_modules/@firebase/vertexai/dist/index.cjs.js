...
class VertexAIModel {
    ...
    constructor(vertexAI, modelName) {
        ...
        else if (!((_f = (_e = vertexAI.app) === null || _e === void 0 ? void 0 : _e.options) === null || _f === void 0 ? void 0 : _f.appId)) {
            throw new VertexAIError("no-app-id" /* VertexAIErrorCode.NO_APP_ID */, `The "appId" field is empty in the local Firebase config. Firebase VertexAI requires this field to contain a valid app ID.`);
        }
        else {
            this._apiSettings = {
                ...
                automaticDataCollectionEnabled: vertexAI.app.automaticDataCollectionEnabled,
                location: vertexAI.location
            };
            if (app._isFirebaseServerApp(vertexAI.app) &&
