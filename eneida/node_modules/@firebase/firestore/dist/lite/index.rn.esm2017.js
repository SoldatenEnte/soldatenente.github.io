 ...
 * limitations under the License.
 */
const P = new a("@firebase/firestore");
...
/** AppCheck token provider for the Lite SDK. */ class __PRIVATE_LiteAppCheckTokenProvider {
    constructor(e, r) {
        this.h = r, this.appCheck = null, this.m = null, t(e) && e.settings.appCheckToken && (this.m = e.settings.appCheckToken), 
        r.onInit((t => {
            this.appCheck = t;
        }));
    }
...
/** The default database name for a project. */ const $ = "(default)";
 ...
 */ class BasePath {
    ...
    static extractNumericId(t) {
        return m.fromString(t.substring(4, t.length - 2));
    }
}
...
/** Converts a Base64 encoded string to a binary string. */ function __PRIVATE_decodeBase64(t) {
    try {
...
class Timestamp {
    ...
    e) {
        ...
        if (t < K) throw new FirestoreError(p, "Timestamp seconds out of range: " + t);
...
function __PRIVATE_typeOrder(t) {
    ...
    function __PRIVATE_isMaxValue(t) {
        return (((t.mapValue || {}).fields || {}).__type__ || {}).stringValue === J;
    }
    /**
 * @license
 ...
 */ (t) ? 9007199254740991 /* TypeOrder.MaxValue */ : 
    ...
    function __PRIVATE_isVectorValue(t) {
        var e, r;
        const n = null === (r = ((null === (e = null == t ? void 0 : t.mapValue) || void 0 === e ? void 0 : e.fields) || {})[H]) || void 0 === r ? void 0 : r.stringValue;
        return n === Z;
    }
 ...
 */ class __PRIVATE_DatastoreImpl extends Datastore {
    ...
    /** Invokes the provided RPC with auth and AppCheck tokens. */    V(t, e, r, n) {
        return this.X(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((([i, s]) => this.connection.V(t, __PRIVATE_toResourcePath(e, r), n, i, s))).catch((t => {
            throw "FirebaseError" === t.name ? (t.code === v && (this.authCredentials.invalidateToken(), 
            this.appCheckCredentials.invalidateToken()), t) : new FirestoreError(I, t.toString());
        }));
    }
    ...
    terminate() {
        this.Z = !0, this.connection.terminate();
    }
}
 ...
 * limitations under the License.
 */
const st = 1048576, ot = "firestore.googleapis.com", at = !0;
...
class FirestoreSettingsImpl {
    constructor(t) {
        ...
        this.localCache = t.localCache, void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < st) throw new FirestoreError(p, "cacheSizeBytes must be at least 1048576");
...
function getFirestore(t, r) {
    const n = "object" == typeof t ? t : e(), i = "string" == typeof t ? t : r || "(default)", s = _getProvider(n, "firestore/lite").getImmediate({
        identifier: i
    });
    if (!s._initialized) {
        const t = h("firestore");
 ...
 */ function terminate(t) {
    return t = __PRIVATE_cast(t, Firestore), r(t.app, "firestore/lite"), t._delete();
}
...
/** A "context" object passed around while parsing user data. */ class __PRIVATE_ParseContextImpl {
    ...
    ct(t) {
        return __PRIVATE_createError(t, this.settings.methodName, this.settings.lt || !1, this.path, this.settings.ht);
    }
    ...
    ot(t) {
        ...
        if (__PRIVATE_isWrite(this.rt) && ut.test(t)) throw this.ct('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class __PRIVATE_UserDataReader {
    ...
    /** Creates a new top-level parse context. */    dt(t, e, r, n = !1) {
...
class __PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
    ...
    _toFieldTransform(t) {
        ...
        /*array=*/ !0), r = this.ft.map((t => __PRIVATE_parseData(t, e))), n = new __PRIVATE_ArrayUnionTransformOperation(r);
...
class __PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
    ...
    _toFieldTransform(t) {
        const e = __PRIVATE_createSentinelChildContext(this, t, 
        /*array=*/ !0), r = this.ft.map((t => __PRIVATE_parseData(t, e))), n = new __PRIVATE_ArrayRemoveTransformOperation(r);
        return new FieldTransform(t.path, n);
    }
    isEqual(t) {
 ...
 */ function getDocs(t) {
    (function __PRIVATE_validateHasExplicitOrderByForLimitToLast(t) {
        if ("L" /* LimitType.Last */ === t.limitType && 0 === t.explicitOrderBy.length) throw new FirestoreError(N, "limitToLast() queries require specifying at least one orderBy() clause");
