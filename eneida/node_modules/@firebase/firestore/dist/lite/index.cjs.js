...
/** AppCheck token provider for the Lite SDK. */ class __PRIVATE_LiteAppCheckTokenProvider {
    constructor(e, r) {
        this.h = r, this.appCheck = null, this.m = null, _isFirebaseServerApp(e) && e.settings.appCheckToken && (this.m = e.settings.appCheckToken), 
        r.onInit((t => {
            this.appCheck = t;
        }));
    }
 ...
 * limitations under the License.
 */
const rt = 1048576, nt = "firestore.googleapis.com", it = !0;
...
class __PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
    ...
    isEqual(t) {
        return t instanceof __PRIVATE_ArrayUnionFieldValueImpl && deepEqual(this.ft, t.ft);
    }
}
...
class __PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
    ...
    isEqual(t) {
        return t instanceof __PRIVATE_ArrayRemoveFieldValueImpl && deepEqual(this.ft, t.ft);
    }
}
 ...
 */ !function __PRIVATE_registerFirestore() {
    ...
    registerVersion("firestore-lite", E, ""), registerVersion("firestore-lite", E, "cjs2017");
}();
