 ...
 * @param {number} mode
 */
export function wasm_set_visualization(engine, mode) {
    _assertClass(engine, WasmEngine);
    wasm.wasm_set_visualization(engine.__wbg_ptr, mode);
}
...
async function __wbg_init(module_or_path, memory) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('planet_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports(memory);
