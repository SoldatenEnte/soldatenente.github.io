 ...
 */
export function create_swarm_cpu(count: number, mesh_id: number, cube_scale: number): WasmEngine;
 ...
 */
export function create_swarm_gpu(count: number, mesh_id: number, cube_scale: number): WasmEngine;
...
export interface InitOutput {
    readonly create_swarm_cpu: (a: number, b: number, c: number) => number;
    readonly create_swarm_gpu: (a: number, b: number, c: number) => number;
